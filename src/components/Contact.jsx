      ...
      <div className="w-[450px] h-[450px] flex flex-col justify-center items-center space-y-10">
        ...
        <form action="#" className="flex flex-col items-center space-y-5 w-full">
          <input
            ...
            required
            className="w-[70%] md:w-full border border-[#e08300] py-1.5 pl-2 rounded-lg focus:outline-none dark:placeholder-[#555]"
          />
          <input
            type="email"
          ...
          <textarea
            ...
            required
            className="w-[70%] md:w-full border border-[#e08300] py-5 pl-2 rounded-lg focus:outline-none dark:placeholder-[#555]"
          ></textarea>
