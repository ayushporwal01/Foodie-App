...
const BottomHeader = () => {
  return (
    <div className="fixed bottom-0 left-0 w-full h-16 bg-white space-x-5 dark:bg-black border-t-1 dark:border-white  p-4 flex justify-around md:hidden z-50 shadow-t">
      {/* Navigation */}
